...
import { SocialPresetsTool } from '@/components/image-processing/social-presets-tool';
              ...
              <div className="flex lg:hidden justify-center gap-6 mb-6">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center">
                    <Icon icon="solar:chat-round-like-line-duotone" className="h-6 w-6 text-white" />
                  </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-teal-600 rounded-xl flex items-center justify-center">
                    <Icon icon="solar:layers-bold-duotone" className="h-6 w-6 text-white" />
                  </div>
                  <div className="text-left">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-red-600 rounded-xl flex items-center justify-center">
                    <Icon icon="solar:download-bold-duotone" className="h-6 w-6 text-white" />
                  </div>
                  <div className="text-left">
              ...
              <div className="hidden lg:block space-y-6">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center">
                    <Icon icon="solar:chat-round-like-line-duotone" className="h-8 w-8 text-white" />
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">8</div>
                    <div className="text-sm text-slate-300">Social Platforms</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-teal-600 rounded-xl flex items-center justify-center">
                    <Icon icon="solar:layers-bold-duotone" className="h-8 w-8 text-white" />
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">60+</div>
                    <div className="text-sm text-slate-300">Size Presets</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-red-600 rounded-xl flex items-center justify-center">
                    <Icon icon="solar:download-bold-duotone" className="h-8 w-8 text-white" />
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">3</div>
                    <div className="text-sm text-slate-300">Free Conversions</div>
                  </div>
                </div>
              </div>
            </div>

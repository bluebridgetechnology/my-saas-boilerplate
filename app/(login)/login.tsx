...
export function Login({ mode = 'signin' }: { mode?: 'signin' | 'signup' }) {
  ...
  const [forgotState, forgotAction, forgotPending] = useActionState<ActionState, FormData>(
    forgotPassword,
    { error: '' }
  );
  ...
  }, [state.error, state.success, forgotState.error, forgotState.success]);
        ...
        <form className="space-y-6" action={formAction}>
          ...
          {mode === 'signin' && (
            <div className="text-center">
              ...
              >
                {forgotPending ? 'Sending...' : 'Forgot your password?'}
              </button>
            </div>
          )}
        </form>
